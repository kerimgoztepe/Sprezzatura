package JavaCybertekEU.assignment_EU2.assignment14_krm.Question13;
...
public class Color {
	...
	//int [][] rgbArray = new int [][] {WHITE, LIGHT_GRAY, GRAY, DARK_GRAY, BLACK, RED, 
...
//		for (int [] arr : rgbArray) {
//			
//			if (Arrays.equals(rgb, arr)) {
